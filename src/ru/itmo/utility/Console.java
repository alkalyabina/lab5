...
import ru.itmo.exceptoins.ScriptRecursionException;
    ...
    private int launchCommand(String[] userCommand) {
        switch (userCommand[0]) {
            ...
            case "update_by_id":
                ...
                break;
            case "remove_by_health":
                if (!commandManager.removeByHealth(userCommand[1])) return 1;
                break;
            case "clear":
            ...
            case "filter_greater_than_chapter":
                if (!commandManager.filterGreaterThanChapter(userCommand[1])) return 1;
                break;
            case "max_by_id":
                if (!commandManager.maxByID(userCommand[1])) {
                    return 1;}
                break;
            case "exit":
